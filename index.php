      ...
      <div class="mx-auto text-center">
        ...
        <h2 class="text-white-50 mx-auto mt-2 mb-5">Descubre qué hacer cuando no tienes idea</h2>   
           <table align='center' cellspacing=10px cellpadding=0 id="data_table" border=0>  
            <tr>
                <td> <a  href="../TUPLANBAQ/login.php" class="btn btn-primary js-scroll-trigger">¡Ingresar!</a></td>
                <td> <a  href="../TUPLANBAQ/signup.php" class="btn btn-primary js-scroll-trigger">¡Crea una cuenta!</a></td>
            </tr>
         </table>
        <?php
          }
